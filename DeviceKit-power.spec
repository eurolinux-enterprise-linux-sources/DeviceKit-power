...
# already upstream
Patch0:    DeviceKit-power-add-can-sleep-methods.patch
...
%package devel-docs
Summary: API documentation for DeviceKit-power
Group: Development/Libraries
Requires: %{name} = %{version}-%{release}
BuildArch: noarch
...
%prep
%setup -q
%patch0 -p1 -b .add-can-sleep-methods
...
%changelog
* Fri Aug 09 2011 Richard Hughes <rhughes@redhat.com> - 014-3
- Fix the multilib file conflict when installing DeviceKit-power-devel
  by splitting out a noarch DeviceKit-power-devel-docs subpackage.
- The reason this is required is that gtk-doc generates random link
  targets in the autogenerated documentation which upsets rpm as the
  files no longer have the same checksum.
- Resolves: #727544

* Fri Jul 22 2011 Richard Hughes <rhughes@redhat.com> - 014-2
- Respect PolicyKit privileges in can_suspend and can_hibernate
- Resolves: #625880
